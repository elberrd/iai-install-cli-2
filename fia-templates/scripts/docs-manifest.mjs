...
export const DOC_MANIFEST = [
  ...
  { id: 'architecture', label: 'Architecture decisions', path: 'ai-docs/architecture.md', kind: 'file', command: '/map', optional: true },
  ...
  { id: 'investigations', label: 'Bug investigations', path: 'ai-docs/investigations', kind: 'dir', command: '/bug', optional: true },
